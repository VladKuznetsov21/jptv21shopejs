               ...
               <div class="card" style="width: 38rem;">
                <div class="card-body">
                    <form id='formAddCover' action="" method="POST" enctype="multipart/form-data">
                        <div class="mb-3 row">
                            <label for="fileName" class="col-sm-5 col-form-label">Product cover:</label>
                            <div class="col-sm-7">
                              <input type="file" class="form-control" id="fileName" name="file" value="">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="descript" class="col-sm-5 col-form-label">Description</label>
                            <div class="col-sm-7">
                              <input type="text" class="form-control" id="descript" name="description" value="">
                            </div>
                        </div>
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <button id='btnAddCover' type="button" class="btn btn-primary me-md-2">Upload</button>
                        </div>
                    </form>
                </div>
               </div>
